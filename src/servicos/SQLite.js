...
export function criaTabela(){
    ...
    db.transaction(transaction => {
        ...
        "CREATE TABLE IF NOT EXISTS "+
        "Abastecimentos " +
        "(id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, data DATE NOT NULL DEFAULT CURRENT_DATE, hodometro INTEGER NOT NULL, valorPorL FLOAT NOT NULL, valor FLOAT NOT NULL, litros FLOAT NOT NULL, local BLOB, obs TEXT, veiculo INTEGER NOT NULL, FOREIGN KEY([veiculo]) REFERENCES [Veiculos]([id]));"
        )
    })
